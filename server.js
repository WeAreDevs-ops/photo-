  ...
  try {
    ...
    const inOverlaySvg = `
      <svg width="500" height="500">
        ...
        <text x="250" y="${overlayPosition + 28}" font-family="Arial, sans-serif" font-size="28" font-weight="bold" 
              fill="${config.accent}" text-anchor="middle">TIME IN</text>
        <text x="250" y="${overlayPosition + 58}" font-family="Arial, sans-serif" font-size="28" font-weight="bold" 
    ...
    if (templateMode === 'background') {
      ...
      const backgroundSvg = `
        <svg width="1000" height="600">
          ...
          <!-- TIME IN Text -->
          <text x="250" y="45" font-family="Arial, sans-serif" font-size="28" font-weight="bold" 
                fill="white" text-anchor="middle" filter="url(#textShadow)">TIME IN</text>
          <text x="250" y="75" font-family="Arial, sans-serif" font-size="32" font-weight="bold" 
          ...
          <!-- TIME OUT Text -->
          <text x="750" y="45" font-family="Arial, sans-serif" font-size="28" font-weight="bold" 
                fill="white" text-anchor="middle" filter="url(#textShadow)">TIME OUT</text>
          <text x="750" y="75" font-family="Arial, sans-serif" font-size="32" font-weight="bold" 
